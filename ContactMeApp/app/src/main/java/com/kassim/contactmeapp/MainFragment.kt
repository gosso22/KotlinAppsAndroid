...
import com.kassim.contactmeapp.databinding.FragmentMainBinding
...
class MainFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val contactButton = view.findViewById<Button>(R.id.buContact)
        val aboutButton = view.findViewById<Button>(R.id.buAbout)
